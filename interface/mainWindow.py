...
"}")
        ...
        self.catyy_pict.setPixmap(QtGui.QPixmap("./img/catyyy.jpg"))
...
"background-color: rgb(247, 242, 255);")
        ...
        self.lapa_cat_pict.setPixmap(QtGui.QPixmap("./img/lapa_cat.jpg"))
...
"")
        ...
        self.cat_ghost_pctr.setPixmap(QtGui.QPixmap("./img/caty ghost1.jpg"))
